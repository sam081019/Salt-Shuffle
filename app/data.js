...
const BUILTIN_MEALS = [
  // ─────────── Indian classics ───────────
  { id: 'chana',    name: 'Chana Masala',          sub: 'with steamed basmati',     type: ['lunch','dinner'], time: 30, kcal: 520, tags: ['Indian', 'Protein'],  tint: ['#e8a05a', '#c66a2a'], pantry: ['chickpeas','onion','tomato','garam_masala','rice','ginger'], img: 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=400&q=80' },
  ...
  { id: 'biryani',  name: 'Veg Biryani',           sub: 'with raita',               type: ['lunch','dinner'], time: 45, kcal: 640, tags: ['Indian', 'Treat'],    tint: ['#c98c4a', '#8a4d18'], pantry: ['rice','mixed_veg','yogurt','biryani_masala','onion'], img: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=400&q=80' },
  ...
  // ─────────── Salads & bowls ───────────
  { id: 'medsalad', name: 'Mediterranean Bowl',    sub: 'chickpea, feta, cucumber', type: ['lunch'],           time: 12, kcal: 440, tags: ['Salad', 'Light'],    tint: ['#7aa05a', '#3a5e2a'], pantry: ['chickpeas','feta','cucumber','tomato','olive_oil'], img: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=400&q=80' },
  ...
  { id: 'avo',      name: 'Avocado Chickpea Salad', sub: 'lemon, chili',            type: ['lunch'],           time: 8,  kcal: 410, tags: ['Salad', 'Quick'],    tint: ['#7c9c4a', '#3e5a1e'], pantry: ['chickpeas','avocado','lemon','chili','red_onion'], img: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=400&q=80' },
